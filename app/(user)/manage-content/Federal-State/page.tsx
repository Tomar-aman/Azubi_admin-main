"use client";
/*
here all the functionality is similar like to job types that why code 
look like job types
*/
...
import {
  ...
  editJobType,
  getJobTypesByFilter,
} from "@/app/api/federal/jobType";
import { COLUMS_DATA as COLUM_DATA } from "./federalState";
...
const ManageJobTypes = () => {
  ...
  return (
    <>
      <Title heading="Manage Federal state" />
