...
export const SIDEBAR_TABS = [
  ...
  { key: "manage-type-of-job", label: "Job Types" },
  { key: "manage-regions", label: "Manage Regions" },
  { key: "manage-cities", label: "Manage Cities" },
  { key: "manage-content", label: "Manage Content" },
  { key: "add-banner", label: "Manage Banners" },
